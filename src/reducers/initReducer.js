  ...
  fwd.forEach(element => {
    if (element.who === "Matty") {
      ...
      if (element.position === "6") {
        totals.Matty.cashWon = Number(0);
      } else { totals.Matty.cashWon = round(Number(element.cashWon)); };
    ...
    if (element.who === "Ando") {
      ...
      if (element.position === "6") {
        totals.Ando.cashWon = Number(0);
      } else { totals.Ando.cashWon = round(Number(element.cashWon)); };
    ...
    if (element.who === "Grady") {
      ...
      if (element.position === "6") {
        totals.Grady.cashWon = Number(0);
      } else { totals.Grady.cashWon = round(Number(element.cashWon)); };
    ...
    if (element.who === "Greg") {
      ...
      if (element.position === "6") {
        totals.Greg.cashWon = Number(0);
      } else { totals.Greg.cashWon = round(Number(element.cashWon)); };
    ...
    if (element.who === "Brad") {
      ...
      if (element.position === "6") {
        totals.Brad.cashWon = Number(0);
      } else { totals.Brad.cashWon = round(Number(element.cashWon)); };
...
function calculator(fwd, state) {
  ...
  fwd.forEach(element => {
    if (element.who === "Matty") {
      totals.Matty.currentPosition = Number(element.position);
      if (element.position === "6") {
        totals.Matty.cashWon = round(Number(state.totals.Matty.cashWon) + Number(0));
      } else { totals.Matty.cashWon = round(Number(state.totals.Matty.cashWon) + Number(element.cashWon)); };
    ...
    if (element.who === "Ando") {
      totals.Ando.currentPosition = Number(element.position);
      if (element.position === "6") {
        totals.Ando.cashWon = round(Number(state.totals.Ando.cashWon) + Number(0));
      } else { totals.Ando.cashWon = round(Number(state.totals.Ando.cashWon) + Number(element.cashWon)); };
    ...
    if (element.who === "Grady") {
      totals.Grady.currentPosition = Number(element.position);
      if (element.position === "6") {
        totals.Grady.cashWon = round(Number(state.totals.Grady.cashWon) + Number(0));
      } else { totals.Grady.cashWon = round(Number(state.totals.Grady.cashWon) + Number(element.cashWon)); };
    ...
    if (element.who === "Greg") {
      totals.Greg.currentPosition = Number(element.position);
      if (element.position === "6") {
        totals.Greg.cashWon = round(Number(state.totals.Greg.cashWon) + Number(0));
      } else { totals.Greg.cashWon = round(Number(state.totals.Greg.cashWon) + Number(element.cashWon)); };
    ...
    if (element.who === "Brad") {
      totals.Brad.currentPosition = Number(element.position);
      if (element.position === "6") {
        totals.Brad.cashWon = round(Number(state.totals.Brad.cashWon) + Number(0));
      } else { totals.Brad.cashWon = round(Number(state.totals.Brad.cashWon) + Number(element.cashWon)); };
